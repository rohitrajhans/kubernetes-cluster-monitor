...
import (
	...
	"github.com/kubernetes-cluster-monitor/controller/pkg/client/clientset/versioned/scheme"
...
// K8sV1alpha1Client is used to interact with features provided by the k8s.crd.io group.
type K8sV1alpha1Client struct {
	restClient rest.Interface
}

func (c *K8sV1alpha1Client) PolicyDefinitions(namespace string) PolicyDefinitionInterface {
